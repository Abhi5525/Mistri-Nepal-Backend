...
class BookingCreateRequest(BaseModel):
    ...
    professional_profile_id: str = Field(..., description="ID of the professional being booked")
    ...
    notes: Optional[str] = Field(None, description="Any specific notes or requirements for the job")
    customer_location: Location = Field(..., description="Location where the service is required")
